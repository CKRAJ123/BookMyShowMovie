...
Route::get('seat_booking', [AuthController::class, 'seat_booking'])->name('seat_booking');
Route::post('paynow', [AuthController::class, 'paynow'])->name('paynow');
Route::get('pay', [AuthController::class, 'generateBookingPaymentToken'])->name('generateBookingPaymentToken');
Route::get('success/{token}/{id}', [AuthController::class, 'MovieTicketSuccess'])->name('MovieTicketSuccess');
